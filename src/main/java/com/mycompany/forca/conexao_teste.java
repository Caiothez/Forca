 ...
 * @author sp300lab
 */
public class conexao_teste extends javax.swing.JFrame {


    conexaoSQL objCon = new conexaoSQL();

    public conexao_teste() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(conexao_teste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new conexao_teste().setVisible(true);
